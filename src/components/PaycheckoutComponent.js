...
paySubmit=()=>{
  alert("Thank you have successfully paid");
}
render(){
  return (
  <>
    <div className="container">
        ...
        <div className="container">
          ...
          <div className="col-md-8  order-md-1">
            ...
            <form onSubmit={()=>this.paySubmit()} className="needs-validation" novalidate>
              <div className="row">
              ...
              <hr className="mb-4"/>
              <button className="btn mb-3 btn-primary btn-lg btn-block" type="submit">Continue to checkout</button>
